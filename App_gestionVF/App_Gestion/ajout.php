...
<html>
	...
	<body onload="CacherDiv();">
		...
		<center>
			<select id="TypeAjout" name="TypeAjout">
			...
			<fieldset>
				<legend>Matériel</legend>
					<form method="post" action="">
						...
						<label>RefDane: <input type="text" name="refdane" /></label><br/>
		...
		<div id="formateur" style="visibility:hidden"> 
			<fieldset>
				<legend>Formateur</legend>
					<form method="post" action="">
						<label>Nom: <input type="text" name="nom" placeholder="Aurelien_GEOFFRAY" /></label><br/>
						<label>Mail:&nbsp <input type="mail" name="mail" placeholder="aurelien.geoffray@ac-lyon.fr"/></label><br/>
						<input type="submit" value="Ajouter" />
					</form>
			</fieldset>
		</div>
