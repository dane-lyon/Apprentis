		...
		<div class="element3">
			<div class="element">
				<div class="container">
					<div class="row">
						<div class="col-sm-6 col-md-4">
						    <div class="thumbnail">
						    	<div class="caption">
						      		<center>
										<form action="index.php?tkn=Reponse_Demande" method="post">
											<p for="ex1">Entrez l'adresse IP du scribe de votre établissement :</p>
											<br>
											...
											<input class="taille" name="TextBox1" type="text" placeholder='172' pattern="[1-1][7-7][2-2]" title="Valeur attendue : 172" required> .
											<!-- Deuxième Octet limité de 16 à 23 -->
											<input class="taille" name="TextBox2" type="text" placeholder='X' pattern="^(12[0-2]|[1-1][6-9]|[2-2][0-3])$" title="Valeur attendue : 16 à 23" required> .
											<!-- Troisième Octet limité de 0 à 255 -->
											<input class="taille" name="TextBox3" type="text" placeholder='Y' pattern="(?!256|257|258|259)^(12[0-5]|1[01][0-9]|[0-1][0-9][0-9]|[1-2][0-5][0-9]|[0-9][0-9]|[0-9]|)$" title="Valeur attendue : 0 à 245" required> .
											<!-- Quatrième Octet limité à 241 ou 245 -->
											<input class="taille" name="TextBox4" type="text" placeholder='241-245' pattern="^([2-2][4-4][1-1]|[2-2][4-4][5-5])" title="Valeur attendue : 241 ou 245" required>
					...
					<!-- Bouton qui ouvre une Modal (pop-up) -->
