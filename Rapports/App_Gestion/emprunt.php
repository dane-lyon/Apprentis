	...
	<body>
		...
		<form action="empruntOK.php" method="post" id="formulaireEmprunt">
			...
			<label class="date">Date d'Emprunt: <br/>
				<input type="" id="datepicker" class="Selec_Date" placeholder="Ex: 12/04/2017" required />
				<div class="ChoisiTaDate">
				<script>
			...
			<label class="date">Date de Retour: <br/>
				<input type="" id="datepicker" class="Selec_Date" placeholder="Ex: 12/04/2017" onclick="$('.datepicker').datepicker()" required />
				<script>
